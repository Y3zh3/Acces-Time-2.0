-- Script simplificado - Solo renombrar lo que falta
...
-- PASO 3: Renombrar columnas de biometricos_faciales
...
-- PASO 4: Renombrar columnas de personal_transporte
...
-- PASO 5: Renombrar columnas de empresas_proveedoras
...
-- PASO 6: Renombrar columnas de personal_proveedores
...
-- PASO 7: Renombrar columnas de registros_acceso
...
-- PASO 8: Renombrar columnas de pases_temporales
...
-- PASO 9: Recrear foreign keys con los nuevos nombres
ALTER TABLE `biometricos_faciales`
...
SELECT '¡Migración completada! Todas las tablas y columnas ahora están en español'  AS resultado;
